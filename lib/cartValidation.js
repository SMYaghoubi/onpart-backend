...
function isProductAvailable(product) {
  return Boolean(product && product.status === 'active' && Number(product.stock) > 0);
}
...
module.exports = { MAX_CART_LINES, MAX_ITEM_QUANTITY, isProductAvailable, normalizeCartItem, normalizeCartItems };
